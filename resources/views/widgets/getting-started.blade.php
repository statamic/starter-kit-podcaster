<div class="card p-0 content max-w-md mx-auto" x-data="{ showList: false }">
    ...
    <div class="py-3 px-6">
        <a href="{{ cp_route('globals.update', 'podcast') }}" class="p-2 flex items-start hover:bg-blue-100 rounded-md group my-8">
            <div class="h-12 w-12 mr-3 text-blue-800 flex items-center justify-center rounded-full bg-blue-100 group-hover:bg-blue-200 p-2">
        ...
        <a href="{{ cp_route('collections.entries.create', ['episodes', Statamic\Facades\Site::default()->handle()]) }}" class="p-2 flex items-start hover:bg-blue-100 rounded-md group mb-8">
            <div class="h-12 w-12 mr-3 text-blue-900 flex items-center justify-center rounded-full bg-blue-100 group-hover:bg-blue-200 p-2">
        ...
        <a href="{{ cp_route('globals.update', 'theme') }}" class="p-2 flex items-start hover:bg-blue-100 rounded-md group mb-8">
            <div class="h-12 w-12 mr-3 text-blue-900 flex items-center justify-center rounded-full bg-blue-100 group-hover:bg-blue-200 p-2">
        ...
        <button x-on:click="showList = true" class="p-2 flex text-left items-star rounded-md group" x-bind:class="!showList && 'hover:bg-blue-100'">
            ...
            <div class="flex-1">
                <h2 class="text-blue-darkest">Distribute your podcast</h2>
        ...
        @if (!Statamic::pro())
        <a href="https://statamic.dev/licensing" class="p-2 flex items-start hover:bg-blue-100 rounded-md group mb-8">
            <div class="h-12 w-12 mr-3 text-blue-900 flex items-center justify-center rounded-full bg-blue-100 group-hover:bg-blue-200 p-2">
